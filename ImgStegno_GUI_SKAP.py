...
class IMG_Stegno:
    ...
    #SKAP- main frame or start page
    def main(self, root):
        root.title('ImageSteganography by SKAP👩‍💻')
        ...
        title = Label(frame,text='SKAP 💻 Image Steganography')
    ...
    #SKAP- back function to loop back to main screen
    def back(self,frame):
        frame.destroy()
        self.main(root)

    
    #SKAP- frame for encode page
    ...
    #SKAP- function to generate data
    ...
    #SKAP- function to modify the pixels of image
    ...
    #SKAP- function to enter the data pixels in image
    ...
    #SKAP- function to enter hidden text
